...
class HolidayService {
  ...
  Future<void> addHoliday(Map<String, dynamic> holidayData) async {
    try {
      await _dio.post(ApiConfig.holidays, data: holidayData);
    } catch (e) {
      throw _parseError(e);
    }
  }
  ...
  Future<void> addBulkHolidays(List<Map<String, dynamic>> holidays) async {
    try {
      await _dio.post(ApiConfig.holidays, data: {'holidays': holidays});
    } catch (e) {
      throw _parseError(e);
    }
  }
  ...
  Future<void> updateHoliday(int id, Map<String, dynamic> updates) async {
    try {
      await _dio.put('${ApiConfig.holidays}/$id', data: updates);
    } catch (e) {
      throw _parseError(e);
    }
  }
  ...
  Future<void> deleteHolidays(List<int> ids) async {
    try {
      await _dio.delete(ApiConfig.holidays, data: {'ids': ids});
    } catch (e) {
      throw _parseError(e);
    }
  }

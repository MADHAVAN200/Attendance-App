...
class PoliciesTabletPortraitView extends StatefulWidget {
  final String? initialTab;
  const PoliciesTabletPortraitView({super.key, this.initialTab});

  @override
  State<PoliciesTabletPortraitView> createState() => _PoliciesTabletPortraitViewState();
}

class _PoliciesTabletPortraitViewState extends State<PoliciesTabletPortraitView> {
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 4),
                _buildTabButton('salary_packages', 'Salary Packages', Icons.payments_outlined, isDark),
              ],
            ),
          ),
        ),
